...
void ACFirstClass::UnitTestACFirstClass()
{
    ...
    if (ACFirstClass::Type().name_ != "AC First Class")
        cout << "Name of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().loadFactor_ != 6.50f)
        cout << "Load Factor of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().isAC_ != 1)
        cout << "AC of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().hasSeat_ != 0)
        cout << "Has Seat of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().numberOfTiers_ != 2)
        cout << "Number of Tiers of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().isLuxury_ != 1)
        cout << "Luxury of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().IsAC() != 1)
        cout << "IsAC function of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().IsSitting() != 0)
        cout << "IsSitting function of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().GetName() != "AC First Class")
        cout << "Name function of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().GetNumberOfTiers() != 2)
        cout << "GetNumberOfTiers function of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().IsLuxury() != 1)
        cout << "IsLuxury function of the ACFirstClass class is wrong !" << "\n";

    if (ACFirstClass::Type().GetLoadFactor() != 6.50f)
        cout << "Load Factor function of the ACFirstClass class is wrong !" << "\n";
}
