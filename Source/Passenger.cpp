...
// Destructor for function class
Passenger::~Passenger() {}

// Functions to get some basic details about the Passenger
...
// Friend function to print the details of the Passenger easily
ostream &operator<<(ostream &os, const Passenger &p)
{
    os << "Passenger Name : " << p.GetName() << "\n";
    os << "Aadhar Number : " << p.GetAadhar() << "\n";
    os << "Mobile Number : " << p.GetMobileNumber() << "\n";
    return os;
}
...
// This function will check the functionalities for the function
void Passenger ::UnitTestPassenger()
{
    try
    {
        Passenger p1 = Passenger ::Construct("CRM", Female::Type(), "123456789111", Date::Construct(17, 12, 1901));
        cout << "CORRECT PASSENGER CONSTRUCTION : PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "CORRECT PASSENGER CONSTRUCTION : FAILED" << "\n";
    }

    try
    {
        Passenger p1 = Passenger ::Construct("CRM", Female::Type(), "123456789111", Date::Construct(17, 12, 3000));
        cout << "INCORRECT PASSENGER DUE TO DOB CONSTRUCTION (NEGATIVE TEST): PASSED" << "\n";
    }
    catch (BadDate &ex)
    {
        cout << "INCORRECT PASSENGER DUE TO DOB CONSTRUCTION (NEGATIVE TEST): FAILED" << "\n";
    }

    try
    {
        Passenger p1 = Passenger ::Construct("CRM", Female::Type(), "12345678911", Date::Construct(17, 12, 2002));
        cout << "INCORRECT PASSENGER DUE TO AADHAR LENGHT CONSTRUCTION (NEGATIVE TEST): PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "INCORRECT PASSENGER DUE TO AADHAR LENGHT CONSTRUCTION (NEGATIVE TEST): FAILED" << "\n";
    }

    try
    {
        Passenger p1 = Passenger ::Construct("CRM", Female::Type(), "1234a6728911", Date::Construct(17, 12, 2002));
        cout << "INCORRECT PASSENGER DUE TO AADHAR DIGITS CONSTRUCTION (NEGATIVE TEST): PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "INCORRECT PASSENGER DUE TO AADHAR DIGITS CONSTRUCTION (NEGATIVE TEST): FAILED" << "\n";
    }

    try
    {
        Passenger p1 = Passenger::Construct("CRM", Male::Type(), "123456789111", Date::Construct(17, 12, 1901), "", "Singh", "78a7658902", "Blind");
        cout << "INCORRECT PASSENGER DUE TO MOBILE DIGITS CONSTRUCTION (NEGATIVE TEST): PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "INCORRECT PASSENGER DUE TO MOBILE DIGITS CONSTRUCTION (NEGATIVE TEST): FAILED" << "\n";
    }

    try
    {
        Passenger p1 = Passenger::Construct("CRM", Male::Type(), "123456789111", Date::Construct(17, 12, 1901), "", "Singh", "787658902", "Blind");
        cout << "INCORRECT PASSENGER DUE TO MOBILE LENGHT CONSTRUCTION (NEGATIVE TEST): PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "INCORRECT PASSENGER DUE TO MOBILE LENGTH CONSTRUCTION (NEGATIVE TEST): FAILED" << "\n";
    }

    try
    {
        Passenger p1 = Passenger::Construct("", Male::Type(), "123456789111", Date::Construct(17, 12, 1901), "", "", "787658902", "Blind");
        cout << "INCORRECT PASSENGER DUE TO FIRST AND LAST NAME CONSTRUCTION (NEGATIVE TEST): PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "INCORRECT PASSENGER DUE TO FIRST AND LAST NAME CONSTRUCTION (NEGATIVE TEST): FAILED" << "\n";
    }
}
