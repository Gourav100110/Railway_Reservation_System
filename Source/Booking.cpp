...
// Function for the reservation of booking between two station.
...
// Destructor for the booking class
Booking::~Booking()
{
...
// Friend function to display the details of the booking
ostream &operator<<(ostream &os, const Booking &b)
{
    os << "\n"
       << b.bookingMessage_ << ":\n";
    os << "PNR Number = " << b.PNR_ << "\n";
    os << "From Station = " << b.fromStation_.GetName() << "\n";
    os << "To Station = " << b.toStation_.GetName() << "\n";
    os << "Travel Date = ";
    (b.dateOfBooking_).print();
    os << "\n";
    os << "Travel Class = " << b.bookingClass.GetName() << "\n";
    ...
    os << " : Bunks: " << b.bookingClass.GetNumberOfTiers() << "\n";
    ...
    os << "Fare = " << (int)(b.ComputeFare()) << "\n";
    return os;
}

// Assigning the variables as told in the problem statement
...
// Unit testing function for the Booking class
// Testing all the functions for the class, and outputing the results
void Booking::UnitTestBooking()
{
    try
    {
        ...
        cout << "CORRECT BOOKING CONSTRUCTION : PASSED" << "\n";
    }
    catch (BadBooking &ex)
    {
        cout << "CORRECT BOOKING CONSTRUCTION : FAILED" << "\n";
    }
    ...
    try
    {
        ...
        cout << "INCORRECT BOOKING DUE TO FROM STATION CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
    }
    catch (BadStation &ex)
    {
        cout << "INCORRECT BOOKING DUE TO FROM STATION CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
    }
    ...
    try
    {
        ...
        cout << "INCORRECT BOOKING DUE TO END STATION CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
    }
    catch (BadStation &ex)
    {
        cout << "INCORRECT BOOKING DUE TO END STATION CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
    }

    Booking *b1 = Booking::ReserveBooking(Station::Construct("Delhi"), Station::Construct("Mumbai"), Date::Construct(12, 5, 2021), Date::Construct(17, 3, 2020), AC3Tier::Type(), General::Type(), Passenger::Construct("Shreyansh", Male::Type(), "123456789111", Date::Construct(17, 12, 2001)));
    for (auto p : Railways::sDistStations)
    {
        if ((p.first.first.GetName() == "Delhi" && p.first.second.GetName() == "Mumbai") || (p.first.first.GetName() == "Mumbai" && p.first.second.GetName() == "Delhi"))
        { // compares the stations and if they are found same
            if (p.second == 0)
            {
                cout << "INCORRECT BOOKING DUE DISTANCE BETWEEN STATION CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
            }
            else
            {
                cout << "INCORRECT BOOKING DUE DISTANCE BETWEEN STATION CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
            }
        }
    }
    ...
    try
    {
        ...
        cout << "INCORRECT BOOKING DUE TO PASSENGER DOB CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
    }
    catch (BadDate &ex)
    {
        cout << "INCORRECT BOOKING DUE TO PASSENGER DOB CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
    }
    ...
    try
    {
        ...
        cout << "INCORRECT BOOKING DUE TO DOR(RESERVATION) < DOB(BIRTH) CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
    }
    catch (BadBooking &ex)
    {
        cout << "INCORRECT BOOKING DUE TO DOR(RESERVATION) < DOB(BIRTH) CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
    }
    ...
    try
    {
        ...
        cout << "INCORRECT BOOKING DUE TO DOR(RESERVATION) > DOB(BOOKING) CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
    }
    catch (BadBooking &ex)
    {
        cout << "INCORRECT BOOKING DUE TO DOR(RESERVATION) > DOB(BOOKING) CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
    }
    ...
    try
    {
        ...
        cout << "INCORRECT BOOKING DUE TO INCORRECT PASSENGER CONSTRUCTION (NEGATIVE TEST) : PASSED" << "\n";
    }
    catch (BadPassenger &ex)
    {
        cout << "INCORRECT BOOKING DUE TO INCORRECT PASSENGER CONSTRUCTION (NEGATIVE TEST) : FAILED" << "\n";
    }
}
