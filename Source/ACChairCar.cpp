...
void ACChairCar::UnitTestACChairCar()
{
    if (ACChairCar::Type().isAC_ != 1)
        cout << "AC of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().hasSeat_ != 1)
        cout << "Has Seat of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().isLuxury_ != 0)
        cout << "Luxury of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().loadFactor_ != 2.0f)
        cout << "Load Factor of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().name_ != "AC Chair Car")
        cout << "Name of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().numberOfTiers_ != 0)
        cout << "Number of Tiers of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().IsSitting() != 1)
        cout << "IsSitting function of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().GetName() != "AC Chair Car")
        cout << "Name function of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().IsLuxury() != 0)
        cout << "IsLuxury function of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().GetNumberOfTiers() != 0)
        cout << "GetNumberOfTiers function of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().IsAC() != 1)
        cout << "IsAC function of the ACChairCar class is wrong !" << "\n";

    if (ACChairCar::Type().GetLoadFactor() != 2.0f)
        cout << "Load Factor function of the ACChairCar class is wrong !" << "\n";
}
