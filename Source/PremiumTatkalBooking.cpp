...
// This function will compute the fare for premium tatkal booking done by the passenger
// It is dependent on the tatkal distances, the calculated fare is returned
