...
void AC2Tier::UnitTestAC2Tier()
{
    ...
    if (AC2Tier::Type().IsAC() != 1)
        cout << "IsAC function of the AC2Tier class is wrong !" << "\n";

    if (AC2Tier::Type().IsLuxury() != 0)
        cout << "IsLuxury function of the AC2Tier class is wrong !" << "\n";

    if (AC2Tier::Type().GetNumberOfTiers() != 2)
        cout << "GetNumberOfTiers function of the AC2Tier class is wrong !" << "\n";
}